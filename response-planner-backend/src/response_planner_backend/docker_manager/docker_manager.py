...
class DockerManager:
    ...
    def stop(
        ...
        and networks. When both are None, remove all dt_* resources.
    ...
    def status(
        ...
        When None, return all dt_* resources.
    ...
    def ensure_deployed(
        ...
        """
        from response_planner_backend.constants.constants \
            import DIGITAL_TWIN
        from response_planner_backend.db.database_facade \
