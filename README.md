...
<p align="center">
<img src="response-planner-frontend/src/components/About/method.png" alt="Method overview" width="600" />
</p>
...
|---------------------|------------------------------------|----------------------------------|
| `POSTGRES_DB`       | PostgreSQL database name           | `incident_response`              |
| `POSTGRES_USER`     | PostgreSQL user                    | `incident_response`              |
...
```bash
cd response-planner-frontend
npm install
npm run build
```

This produces a production bundle in `response-planner-frontend/build/`.
