...
/**
 * Renders the final validation report for the Validation Agent.
 */
function ValidationAgentReport({ entry, index, isExpanded, toggleEntry }) {
  if (entry.type !== 'validation_report') return null
...
export default ValidationAgentReport
