# Response Planner Frontend

React frontend for the Incident Response Planner built with Vite.
...
docker compose exec app bash -c "cd response-planner-frontend && npm start"
docker compose exec app bash -c "cd response-planner-frontend && npm test"
docker compose exec app bash -c "cd response-planner-frontend && npx eslint . --quiet"
docker compose exec app bash -c "cd response-planner-frontend && npm run build"
```
