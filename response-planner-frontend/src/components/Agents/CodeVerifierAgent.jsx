...
import CodeVerifierConfigTab from './CodeVerifierConfigTab.jsx'
import CodeVerifierReport from './CodeVerifierReport.jsx'
...
/**
 * CodeVerifierAgent component — drives the code review agent loop with
 * human-in-the-loop tool approval. Renders 3 inner tabs.
 */
function CodeVerifierAgent() {
...
export default CodeVerifierAgent
