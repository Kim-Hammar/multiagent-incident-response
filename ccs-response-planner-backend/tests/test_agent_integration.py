...
class TestReportManagerIntegration:
    ...
    def test_orchestrates_report_flow(self):
        ...
        """
        from ccs_response_planner_backend.agents.report_manager_agent.agent import (  # noqa: E501
            ReportManagerAgent,
        )
        from ccs_response_planner_backend.agents.report_manager_agent.tools import (  # noqa: E501
            STREAMING_TOOL_DISPATCH,
            TOOL_DISPATCH,
        )
...
class TestCodeManagerIntegration:
    ...
    def test_orchestrates_code_flow(self):
        ...
        """
        from ccs_response_planner_backend.agents.code_manager_agent.agent import (  # noqa: E501
            CodeManagerAgent,
        )
        from ccs_response_planner_backend.agents.code_manager_agent.tools import (  # noqa: E501
            STREAMING_TOOL_DISPATCH,
            TOOL_DISPATCH,
        )
...
class TestPlanManagerIntegration:
    ...
    def test_orchestrates_full_pipeline(self):
        ...
        from ccs_response_planner_backend.agents.plan_manager_agent.tools import (  # noqa: E501
            STREAMING_TOOL_DISPATCH,
            TOOL_DISPATCH,
        )
